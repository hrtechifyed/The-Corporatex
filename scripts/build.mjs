...
function withProductionRuntime(html, { submit = false } = {}) {
  let output = html;
  for (const stylesheet of ['src/github-shell.css','src/visual-fixes-guide.css','src/guided-anime-fix.css','src/stories-polish.css','src/guided-production.css','src/guided-account-polish.css','src/home-live-signals.css','src/home-story-carousel.css','src/location-autocomplete.css','src/employment-context.css','src/moderation-console.css','src/account-submissions.css','src/login-role.css','src/site-chrome-cleanup.css','src/card-gold-accent.css','src/stories-live-art.css','src/home-published-card.css','src/exit-journey-signal.css','src/footer-compact.css','src/home-story-priority.css']) {
