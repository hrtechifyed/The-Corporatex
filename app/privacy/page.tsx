      ...
      <section className="cx-section cx-light-section">
        <div className="cx-shell">
          ...
          <div className="cx-info-stack">
            ...
            <details><summary>What is stored for a submission?</summary><p>CorporateX stores contributor-approved Story Beats, broad workplace context, moderation status and related private submission records after an authenticated submission is created. New submissions enter moderation rather than publishing automatically. The Render staging verification flow may also create a private recoverable handoff so a verification link can resume a completed contribution across browsers/devices; that handoff is not public content.</p></details>
